...
export function useNotifications(params: FetchParams = {}) {
 ...
 const fetchData = useCallback(
  ...
  headers: {
    "authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..pnsWrKwo6UChSdUpNBe3_WJuN8Wbx-3ueFb-DWUfpWk",
  },
});
        if (!res.ok) {
